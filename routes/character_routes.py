...
class CharacterRouter(BaseRouter):
    ...
    async def get_all_characters(self, service = Depends(get_character_service), db: Session = Depends(get_db)):
    ...
    async def get_character_by_name(self, name: str, service = Depends(get_character_service), db: Session = Depends(get_db)):
    ...
    async def create_character(self, character: CharacterCreate, service = Depends(get_character_service), db: Session = Depends(get_db)):
    ...
    async def delete_character(self, id: Union[int, str], service = Depends(get_character_service), db: Session = Depends(get_db)):
    ...
    async def update_character(self, id: Union[int, str], character: CharacterCreate, service = Depends(get_character_service), db: Session = Depends(get_db)):
