...
class CharacterService(BaseService):
    ...
    def get_all_characters(self, db: Session) -> List[Character]:
        """Get all characters with their details"""
        return self.get_all(db)
    
    def get_character_by_name(self, db: Session, name: str) -> List[Character]:
    ...
    def create_character(self, db: Session, character_data: dict) -> Character:
